...
--events when it results in new mining-drill
...
script.on_event(defines.events.on_built_entity, miningDrillNewEventHandler, {{filter = "type", type = "mining-drill"}} )
script.on_event(defines.events.on_robot_built_entity, miningDrillNewEventHandler, {{filter = "type", type = "mining-drill"}} )



--events when it results in destroying mining-drill
...
script.on_event(defines.events.on_player_mined_entity, miningDrillDestroyEventHandler, {{filter = "type", type = "mining-drill"}})
script.on_event(defines.events.on_robot_mined_entity, miningDrillDestroyEventHandler, {{filter = "type", type = "mining-drill"}})
script.on_event(defines.events.on_entity_died, miningDrillDestroyEventHandler, {{filter = "type", type = "mining-drill"}})
